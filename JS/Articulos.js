var urlGetArticulo = 'http://localhost:90/G4_20/controller/Articulos.php?op=GetArticulos';
var urlPostArticulo='http://localhost:90/G4_20/controller/Articulos.php?op=InsertArticulo';
var urlGetUno = 'http://localhost:90/G4_20/controller/Articulos.php?op=GetUno';
var urlPutArticulo = 'http://localhost:90/G4_20/controller/Articulos.php?op=ActualizarArticulo';
var urlDeleteArticulo = 'http://localhost:90/G4_20/controller/Articulos.php?op=EliminarArticulo'
